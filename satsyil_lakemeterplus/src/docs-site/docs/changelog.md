...
## Unreleased — satsyil_lakemeterplus merge

This documentation site and the codebase it describes were merged with a
second project, `databricks-cost-observability`, into `satsyil_lakemeterplus`
— see the new [Cost Observability](./observability-guide/overview) section
and, for merge mechanics, `docs/merge-tasks.md` and `docs/TODO.md` at the
repository root. Not an official Lakemeter release; no version number has
