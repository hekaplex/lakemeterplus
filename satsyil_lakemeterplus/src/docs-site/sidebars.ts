...
const sidebars: SidebarsConfig = {
  ...
  // Cost-observability module, merged in from a separate project — see
  // docs/merge-tasks.md at the repository root and
  // observability-guide/merge-notes for what that involved.
  observabilityGuideSidebar: [
    {
      type: 'category',
      ...
      items: [
        ...
        'observability-guide/features',
        'observability-guide/deployment',
        'observability-guide/merge-notes',
      ],
    },
  ],
  changelogSidebar: [
