...
# Cost-observability module, ported from databricks-cost-observability.
# router.py already prefixes each sub-router with "/observability" (e.g.
# "/observability/cost", "/observability/executive"), so mounting the
# aggregate router at "/api/v1" yields /api/v1/observability/* — distinct
# from Lakemeter's own /api/v1/* estimation routes, no collisions.
